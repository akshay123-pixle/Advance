...
//__resolveReference is a special function that says:
// "When another service sends me a reference to a Product (with just an ID), here's how I find the full product info in my own data."
  Mutation:{
